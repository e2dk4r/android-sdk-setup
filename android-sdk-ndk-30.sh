...
test -f platform-30_r03.zip || curl -sSLO https://dl.google.com/android/repository/platform-30_r03.zip
...
test -f android-ndk-r25b-linux.zip || curl -sSLO https://dl.google.com/android/repository/android-ndk-r25b-linux.zip
...
# required by ndk
test -f 3534162-studio.sdk-patcher.zip || curl -sSLO https://dl.google.com/android/repository/3534162-studio.sdk-patcher.zip
...
test -f build-tools_r30-linux.zip || curl -sSLO https://dl.google.com/android/repository/build-tools_r30-linux.zip
...
# optional
#test -f emulator-linux_x64-9189900.zip || curl -sSLO https://dl.google.com/android/repository/emulator-linux_x64-9189900.zip
