...
test -f platform-30_r03.zip || curl -LO https://dl.google.com/android/repository/platform-30_r03.zip
echo 'f3f5b75744dbf6ee6ed3e8174a71e513bfee502d0bc3463ea97e517bff68d84e  platform-30_r03.zip' | sha256sum -c
unzip platform-30_r03.zip
mkdir -p $ANDROID_HOME/platforms
mv android-11 $ANDROID_HOME/platforms/android-30

test -f android-ndk-r25b-linux.zip || curl -LO https://dl.google.com/android/repository/android-ndk-r25b-linux.zip
...
# required by ndk
test -f 3534162-studio.sdk-patcher.zip || curl -LO https://dl.google.com/android/repository/3534162-studio.sdk-patcher.zip
echo '18f9b8f27ea656e06b05d8f14d881df8e19803c9221c0be3e801632bcef18bed  3534162-studio.sdk-patcher.zip' | sha256sum -c
unzip 3534162-studio.sdk-patcher.zip
mkdir -p $ANDROID_HOME/patcher
mv sdk-patcher $ANDROID_HOME/patcher/v4

test -f build-tools_r30-linux.zip || curl -LO https://dl.google.com/android/repository/build-tools_r30-linux.zip
...
# optional
#test -f emulator-linux_x64-9189900.zip || curl -LO https://dl.google.com/android/repository/emulator-linux_x64-9189900.zip
#echo '5d18602e9a4e39eb88d01a243fe0df061dcec945042e385dafa4de4a848d29ce  emulator-linux_x64-9189900.zip' | sha256sum -c
#unzip emulator-linux_x64-9189900.zip
